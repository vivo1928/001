...
const Volume = () => {
  ...
  const handleSlidingStart: SliderProps['onSlidingStart'] = useCallback((value: number) => {
    value = Math.trunc(value)
    setSliderSize(value)
    void setVolume(value / 100)
  }, [])

  const handleValueChange: SliderProps['onValueChange'] = useCallback((value: number) => {
    value = Math.trunc(value)
    setSliderSize(value)
    void setVolume(value / 100)
  }, [])
